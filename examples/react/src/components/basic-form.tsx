    ...
    <>
      <form noValidate onSubmit={handleSubmit}>
        <TextInputField
          ...
          validationMessage={
            (submitted || fields.firstName?.touched) && errors.firstName
          }
        />
        <TextInputField
          label="Last name"
          ...
          validationMessage={
            (submitted || fields.lastName?.touched) && errors.lastName
          }
        />
        <TextInputField
          label="Age"
          ...
          validationMessage={(submitted || fields.age?.touched) && errors.age}
        />
...
const validator = object({
  firstName: err(
    and(string, length(1, 24)),
    'Enter your first name (maximum 24 characters)'
  ),
  lastName: err(
    or(undef, and(string, length(1, 24))),
    'Your last name is too long (maximum is 24 characters)'
  ),
  age: err(
    and(integer, min(0), max(130)),
    'Enter your age in years (maximum is 130)'
  )
});
